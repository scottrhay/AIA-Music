# n8n Workflow Updates for AIA Music

This document explains how to update your existing n8n workflow to work with the new MySQL-based AIA Music instead of Excel.
...
**NEW:** HTTP Request to AIA Music webhook

**HTTP Request Node:**
- Method: POST
- URL: `https://music.aiacopilot.com/api/v1/webhooks/azure-submitted`
- Headers:
...
**HTTP Request Node:**
- Method: POST
- URL: `https://music.aiacopilot.com/api/v1/webhooks/azure-callback`
- Headers:
  - Content-Type: application/json
- Body:
```json
...
1. Create a test song in AIA Music with status "create"
...
GET https://music.aiacopilot.com/api/v1/songs/pending-submission
Headers:
...
- **Fix:** Check Flask logs: `sudo journalctl -u aiamusic -f`
- Verify webhook URL is correct
- Check if AIA Music API is running
