...
# Create database
mysql -u root -p
CREATE DATABASE aiamusic_dev CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
CREATE USER 'aiamusic_dev'@'localhost' IDENTIFIED BY 'devpassword';
GRANT ALL PRIVILEGES ON aiamusic_dev.* TO 'aiamusic_dev'@'localhost';
FLUSH PRIVILEGES;
exit;

# Import schema
mysql -u root -p aiamusic_dev < ../database/schema.sql
```
...
DB_HOST=localhost
DB_PORT=3306
DB_NAME=aiamusic_dev
DB_USER=aiamusic_dev
...
```bash
# Connect to database
mysql -u aiamusic_dev -p aiamusic_dev
