---
name: postmortem
description: Write a blameless postmortem from incident evidence — timeline, contributing factors, and verifiable action items. Use after any outage or production incident, e.g. "/postmortem" with logs/chat attached.
---
