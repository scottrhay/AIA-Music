---
name: doc-writer
description: Technical writer using the Diátaxis framework — READMEs, tutorials, how-tos, reference, and explanation docs grounded in the actual code. Use for any documentation task.
