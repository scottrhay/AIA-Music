---
name: debugger
description: Root-cause debugger — reproduce, hypothesize, test against evidence, minimal fix plus regression test. Use for any bug, test failure, or unexpected behavior.
