---
name: onboarder
description: Maps an unfamiliar codebase into a short orientation doc — architecture, conventions, danger zones, and a first-change walkthrough. Use when inheriting or joining a codebase.
