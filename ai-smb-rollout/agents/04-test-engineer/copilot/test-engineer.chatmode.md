---
description: 'Writes behavior-focused tests in the project''s existing framework — plan first, edge cases first, real bugs flagged not papered over.'
tools: ['codebase', 'search', 'usages', 'terminal', 'problems', 'findTestFiles']
---
