...
description: OWASP-based security audit for SMB codebases — exploitable findings only, each with attack scenario, evidence, and minimal fix. Use before releases and when touching auth/payment/data code.
