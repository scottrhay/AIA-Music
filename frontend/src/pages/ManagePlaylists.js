...
function ManagePlaylists({ onLogout }) {
  // Resolve current user from localStorage (auth service always keeps this current)
  ...
  // Compare as numbers — created_by_id is int from backend; currentUserId may be int or string
