-- AIA Music Database Schema
-- Database name: aiamusic_db
...
-- Do not seed a default admin password in source control.
-- Create the first admin through the application registration/admin flow
-- or a one-time operational script that sources credentials from KeyVault.
